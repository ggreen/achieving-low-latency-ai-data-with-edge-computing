PLUGINS="rabbitmq_amqp1_0,rabbitmq_shovel,rabbitmq_shovel_management,rabbitmq_stream,rabbitmq_stream_browser,rabbitmq_stream_management"

echo "Starting Tanzu RabbitMQ with initial plugins: $PLUGINS..."

podman run -it --rm \
  --name=rabbitmq                                           4.3-management \
  -p 5672:5672 \
  -p 5552:5552 \
  -p 15672:15672 \
  -p 1883:1883 \
